...
\begin{comment}
Si je comprend :
1) Nouveau node arrive : Discovery message (broadcast)
2) Parents potentiel répondent : VADOR message
3) Le noeud choisi un parent et envoi : ACK_PARENT (unicast)

Et pendant leur fonctionnement, les différents noeuds envoient périodiquement des requête INFO  contenant les relevés des senseurs
gg - Aujourd'hui à 20:42
yup et 4) parent ajoute fils à une liste de ses enfants pour pouvoir leur broadcast les configs
\end{comment}
